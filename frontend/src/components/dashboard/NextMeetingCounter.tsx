          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.4em] text-primary mb-2 italic">
                SİRADAKİ CANLI ETKİNLİK
              </p>
              <h2 className="text-2xl md:text-3xl font-black text-gray-900 tracking-tight leading-none mb-3">
                {nextEvent.title}
              </h2>
          ...
          <div className="flex flex-col items-center gap-2">
            {nextEvent.meeting_link ? (
              ...
              <div className="text-center px-6">
                <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1 italic">LİNK BEKLENİYOR</p>
                <p className="text-[11px] font-bold text-gray-500 leading-tight">Yayın saati yaklaştığında link burada görünecektir.</p>
              </div>
            )}
          </div>
...
function TimeUnit({ value, label }: { value: number, label: string }) {
  return (
    <div className="flex flex-col items-center min-w-[45px]">
      <span className="text-2xl md:text-4xl font-black text-gray-900 tabular-nums tracking-tighter">
...
function Divider() {
  return <div className="w-[1px] h-10 bg-gray-900/10" />;
}
